...
public interface CRMConstanst {
	
	public String dashboardText="Marketing Dashboard";
	public String Contacts = "Contacts";
	public String Forms = "Forms";
	public String  InlineForms = "Inline Forms";
	public String NewContact = "New Contact";
